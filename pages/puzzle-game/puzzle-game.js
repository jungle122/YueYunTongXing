...
Page({
  data: {
    puzzleData: [
      { title: "拼出完整的童谣：鸡公仔", songId: "song28", pieces: ["鸡公仔，尾婆婆","三岁孩儿学唱歌","唔使爹娘教导我","自己精乖冇奈何"] },
      {
        title: "拼出童谣片段：月光光",
        songId: "song18",
        pieces: [
      ...
      },
      {
        title: "拼出完整的童谣：点虫虫",
        songId: "song25",
        pieces: ["点虫虫，虫虫飞", "飞到荔枝基", "荔枝熟，摘满桶", "荔枝生，摘满筐"]
      },
      {
        title: "拼出完整的童谣：排排坐",
        songId: "song26",
        pieces: ["排排坐，食粉果", "猫儿担凳姑婆坐", "猪拉柴，狗透火", "坐烂个屎忽唔好赖我"]
      },
      {
        title: "拼出完整的童谣：打开蚊帐",
        songId: "song27",
        pieces: ["打开蚊帐，打开蚊帐", "有只蚊，有只蚊", "快啲攞把扇嚟", "快啲攞把扇嚟"]
      },
      {
