...
var songs = [
  {
    ...
    lyrics: ["月光光 照地堂", "蝦仔你乖乖瞓落床", "聽朝阿媽要趕插秧啰", "阿爺睇牛佢上山崗", "喔……", "蝦仔你快高長大啰", "幫手阿爺去睇牛羊", "喔……", "", "月光光 照地堂", "蝦仔你乖乖瞓落床", "聽朝阿爸要捕魚蝦啰", "阿嬤織網要織到天光", "喔……", "蝦仔你快高長大啰", "劃艇撒網就更在行", "喔……"],
  ...
  },
  {
    ...
    lyrics: ["齐齐望过去", "清溪里 有只青蛙想跳水", "齐齐望过去", "小屋里 有只猪仔真风趣", "有只了哥 吱吱喳喳想驳嘴", "齐齐望过去", "山窿里 有只狮子竟饮醉"],
  ...
  },
  {
    ...
    lyrics: ["落雨大水浸街", "阿哥担柴上街卖", "阿嫂出街着花鞋", "花鞋花袜花腰带", "珍珠蝴蝶两边排"],
  ...
  },
  {
    ...
    lyrics: ["氹氹转啊 菊花园", "炒米饼 糯米糯米团", "五月初五系龙舟节呀", "阿妈叫我去睇龙船", "我唔去睇 我要睇鸡仔", "鸡仔大我拎去卖", "卖得几多钱 卖咗几多只呀", "我有只风车仔 佢转得好好睇", "睇佢氹氹转呀菊花园", "睇佢氹氹转呀 氹氹转又转"],
  ...
  },
  {
    ...
    lyrics: ["真怪诞呀又有趣，", "你望望公园内，", "有四百只鸡鸡咕咕咕，", "是何家的不知道，", "何家公鸡何家猜，", "何家小鸡何家猜，", "何家公鸡何家猜，", "何家母鸡咯咯咯，", "猴子哥哥熊先生，", "松鼠妹妹牛叔叔，", "黄狗爸爸羊妈妈，", "来猜来猜呦。"],
  ...
  },
  {
    ...
    lyrics: ["洗白白　洗白白　人人話我好寶寶", "洗白白　洗白白　肥皂多香滑", "蚤乸蚤乸人害怕　污污糟糟實太差", "洗白白　洗白白　才是好小孩"],
